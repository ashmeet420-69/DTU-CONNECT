...
public class PhotoAdapter extends ArrayAdapter {
    ...
    public PhotoAdapter(@NonNull Activity context, ArrayList<String> photo, ArrayList<Date> postdate, ArrayList<String> name, ArrayList<String> caption, ArrayList<String> id, ArrayList<Integer> likes, ArrayList<ArrayList<String>> likeby, ArrayList<ArrayList<String>> commentBy, ArrayList<ArrayList<String>> commentlist) {
        super(context, R.layout.list_feed, photo);
    ...
    @NonNull
    @Override
    public View getView(final int poition, @Nullable View convertView, @NonNull ViewGroup parent) {
