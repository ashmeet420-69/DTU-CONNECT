...
public class LanguageDialog extends DialogFragment {
    ...
    UserData userData;
    public LanguageDialog(UserData userData)
    {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
       ...
       GridView langgrid = new GridView(getContext());
        ...
        Toast.makeText(getContext(), ""+userData.language.size(), Toast.LENGTH_SHORT).show();
        Language_SkillAdapter adapter=new Language_SkillAdapter(getActivity(), android.R.layout.simple_list_item_1, userData.language);
